...
import type { BeforeAfter } from "@/lib/db";
...
export default function AntesDepoisPage() {
  ...
  const remove = async (id: string) => {
    ...
    await fetch(`/api/admin/before-after?id=${id}`, { method: "DELETE", credentials: "include" });
    load();
  };
  ...
  return (
    <div>
      <h1 className="font-playfair text-2xl font-semibold text-white md:text-3xl">Antes e Depois</h1>
      <p className="mt-1 text-zinc-400">Galeria de transformações</p>
